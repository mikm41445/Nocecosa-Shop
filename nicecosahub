    if game.CoreGui:FindFirstChild("NICECOSAHUBMODILE") then
        game.CoreGui:FindFirstChild("NICECOSAHUBMODILE"):Destroy()
    end

        local NICECOSAHUB = Instance.new("ScreenGui")
        local MODILEGUINICECOSAHUB = Instance.new("TextButton")
        local MODILEGUINICECOSAHUB = Instance.new("UICorner")
        local MODILEMAGE = Instance.new("ImageLabel")

        NICECOSAHUBMODILE.Name = "NICECOSAHUB"
        NICECOSAHUBMODILE.Parent = game.CoreGui
        NICECOSAHUBMODILE.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

        MODILEGUINICECOSAHUB.Name = "MODILEGUINICECOSAHUB"
        MODILEGUINICECOSAHUB.Parent = NICECOSAHUBMODILE
        MODILEGUINICECOSAHUB.BackgroundColor3 = Color3.fromRGB(30,20,20)
        MODILEGUINICECOSAHUB.BorderSizePixel = 0
        MODILEGUINICECOSAHUB.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
        MODILEGUINICECOSAHUB.Size = UDim2.new(0, 50, 0, 50)
        MODILEGUINICECOSAHUB.Font = Enum.Font.SourceSans
        MODILEGUINICECOSAHUB.Text = ""
        MODILEGUINICECOSAHUB.TextColor3 = Color3.fromRGB(0, 0, 0)
        MODILEGUINICECOSAHUB.TextSize = 14.000
        MODILEGUINICECOSAHUB.Draggable = true
        MODILEGUINICECOSAHUB.MouseButton1Click:Connect(function()
        game.CoreGui:FindFirstChild("NICECOSA HUB").Enabled = not game.CoreGui:FindFirstChild("NICECOSA HUB").Enabled
        end)
            do
                if game:GetService("CoreGui"):FindFirstChild("NICECOSA HUB") then
            end
        end

        MODILEGUINICECOSAHUBHUI.Name = "MODILEGUINICECOSAHUBHUI"
        MODILEGUINICECOSAHUBHUI.Parent = MODILEGUINICECOSAHUB

        MODILEMAGE.Name = "MODILEMAGE"
        MODILEMAGE.Parent = MODILEGUINICECOSAHUB
...
do
	local ui = game.CoreGui:FindFirstChild("NICECOSAHUB")
	if ui then
		ui:Destroy()
	end
...
function library:AddWindow(text,logo,keybind)
	...
	local NICECOSAHUB = Instance.new("ScreenGui")
	NICECOSAHUB.Name = "NICECOSAHUB"
	NICECOSAHUB.Parent = game.CoreGui
	NICECOSAHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = NICECOSAHUB
